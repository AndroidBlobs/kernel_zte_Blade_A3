...
static __init int get_otg_support(char *str)
{
	if (strcmp(str, "VFD420") == 0)
		unsupport_ufp = 1;
	else
		unsupport_ufp = 0;
	pr_info("Hardware %s unsupport_otg:%d\n", str, unsupport_ufp);

	return 0;
}

__setup("androidboot.hardware=", get_otg_support);
