...
//#define EMBEDDED_FUNCTION_SIGN_MOTION_SUPPORT
//#define EMBEDDED_FUNCTION_STEP_COUNTER_SUPPORT
//#define EMBEDDED_FUNCTION_STEP_DETECTOR_SUPPORT
//#define EMBEDDED_FUNCTION_TILT_SUPPORT

#define CONFIG_ST_HARDWARE_INTERRUPT 0
