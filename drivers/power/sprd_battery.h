...
#define SPRDBAT_CHG_END_TEMP_VOL_BIT    BIT(11)
...
struct sprd_battery_platform_data {
	...
	uint32_t fchg_vol;
	uint32_t rechg_vol;
	uint32_t chg_end_vol_z;
	uint32_t chg_end_cur_z;
	uint32_t rechg_vol_z;
